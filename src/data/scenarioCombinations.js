	...
	scenarioCombinations : 
		{ 
			scenarioOptions : [ 
				...
				{ 
					"id": 15, 
					"name": "FutureDH_copy_Ambitious", 
					"nameNoOptions": "FutureDH_copy", 
					"short_description": "FutDH+A", 
					"ultra_short_description": "FDH+A", 
					"desc": "Low-Temperature District Heating with Low-Temperature Heat Sources Ambitious Scenario Net Zero Emission by 2030 compared to 2015", 
					"opt 0": true, 
			...
			optionsAvailable: { 
				...
				"FutureDH_copy_Ambitious": { 
					"opt 0": true,
					"opt 1": true,
					"opt 2": true,
					"opt 3": false,
					}, 
				"FutureDH_copy_WEO-SD": { 
					"opt 0": true,
					"opt 1": true,
					"opt 2": true,
					"opt 3": false,
					}, 
				"FutureDH_copy_WEO-NP": { 
					"opt 0": true,
					"opt 1": true,
					"opt 2": true,
					"opt 3": false,
